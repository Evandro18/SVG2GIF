...
SCREENSHOTS_PER_SECOND = 12  # This arbitrary number worked but is not perfect
...
print(f"Animation timers: {animation_timers}")
total_time_animated = ceil(max(animation_timers or [2]))
print(f"Total time animated: {total_time_animated} seconds")
